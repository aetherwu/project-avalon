	...
	<language>zh-cn</language>
		...
		<asp:Repeater id="postList" OnItemDataBound="postList_ItemDataBound" runat="server"><ItemTemplate><item>
			...
			<![CDATA[ 
				...
				<div style="margin:10px 0;color:#999;border:1px solid #efefef;background:#fafafa;padding:10px;">写于<%# DataBinder.Eval(Container.DataItem,"PostTime","{0:HH:mm:ss}") %></div>
				<%# Eval("Content") %>
				<br/>
				<br/>
